 ...
 * VRAM, 2560 CUDA cores). Real, corrected state (2026-08-11): cs-careeradvisor is
 ...
 * and cs-careeradvisor is a real 32B model (Aya Expanse), partially GPU-offloaded
 * (see cs_fixed/models/Modelfile.cs-careeradvisor's own 2026-08-08 production-OOM
